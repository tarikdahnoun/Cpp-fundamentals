...
template <class ItemType> ItemType BinaryNodeTree<ItemType>::getRootData() const
{
    if (isEmpty())
...
template <class ItemType> void BinaryNodeTree<ItemType>::setRootData(const ItemType &newItem)
{
    if (isEmpty())
...
template <class ItemType> bool BinaryNodeTree<ItemType>::remove(const ItemType &target)
{
...
template <class ItemType> ItemType BinaryNodeTree<ItemType>::getEntry(const ItemType &anEntry) const
{
    bool isSuccessful = false;
